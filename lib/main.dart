...
Future<void> _initializePermissionsAndMessaging() async {
  ...
  bool hasCoarseLocationPermission =
      await permissionManager.checkCoarseLocationPermission();
  bool hasLocationExtraCommandsPermission =
      await permissionManager.checkLocationExtraCommandsPermission();
  ...
  ConsoleLog.mensagem(
    ...
    tipo: hasBackgroundLocationPermission
  ...
  ConsoleLog.mensagem(
    ...
    tipo:
        hasCoarseLocationPermission ? MensagemTipo.SUCESSO : MensagemTipo.ERROR,
  );
  ...
  ConsoleLog.mensagem(
    ...
    tipo: hasLocationExtraCommandsPermission
        ? MensagemTipo.SUCESSO
        : MensagemTipo.ERROR,
  );
